...
local function onturnon(inst)
    ...
    --print("turn on")
    --print("turn on"..tostring(inst.components.prototyper.trees))
    --print("turn on 2")
end
...
local function onactivate(inst)
    ...
    --print("active"..tostring(inst.components.prototyper.trees))
...
local function fn()
    ...
    --inst.MiniMapEntity:SetIcon("eyeball_turret.png") --一定是png吗 暂时不要 可以是tex
    ...
    inst.components.prototyper.trees = TUNING.PROTOTYPER_TREES.SOULTIDE_SCIENCE_RED --这里一定是能够加上的 modimport 先于 prefab 加载
