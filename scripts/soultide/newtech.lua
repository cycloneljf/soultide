...
=======
TECH.SOULTIDE_SCIENCE_BLUE = { SOULTIDE_SCIENCE = 1} --区别在于hint只会hint下一级
TECH.SOULTIDE_SCIENCE_PURPLE = { SOULTIDE_SCIENCE = 2}
TECH.SOULTIDE_SCIENCE_GOLDEN = { SOULTIDE_SCIENCE = 3}
TECH.SOULTIDE_SCIENCE_RED = { SOULTIDE_SCIENCE = 4}
TECH.SOULTIDE_SCIENCE_CRYSTAL = { SOULTIDE_SCIENCE = 5}

--[[ 原型科技树中加入自己的部分 ]]
for k,v in pairs(TUNING.PROTOTYPER_TREES) do --系统的科技树变量
    v.SOULTIDE_SCIENCE = 0
end
TUNING.PROTOTYPER_TREES.SOULTIDE_SCIENCE_BLUE = TechTree.Create({SOULTIDE_SCIENCE = 1})
TUNING.PROTOTYPER_TREES.SOULTIDE_SCIENCE_PURPLE = TechTree.Create({SOULTIDE_SCIENCE = 2})
TUNING.PROTOTYPER_TREES.SOULTIDE_SCIENCE_GOLDEN = TechTree.Create({SOULTIDE_SCIENCE = 3})
TUNING.PROTOTYPER_TREES.SOULTIDE_SCIENCE_RED = TechTree.Create({SOULTIDE_SCIENCE = 4})
TUNING.PROTOTYPER_TREES.SOULTIDE_SCIENCE_CRYSTAL = TechTree.Create({SOULTIDE_SCIENCE = 5})
